...
step_texts = {
    ...
    6: "**Step 6: No-Load & Total Current.** $I_0$ is built around $\Phi$. The total primary current is $I_1 = I_1^\prime + I_0$.",
...
if step >= 5:
    draw_vector(I1_prime, 'crimson', r'$I_1^\prime$', (-0.2, 0.05), width=1.0)

...
while st.session_state.running:
    ...
    # Waveforms
    fig.add_trace(go.Scatter(x=t_axis, y=v_wave, line=dict(color='crimson'), opacity=0.3), row=1, col=2)
    fig.add_trace(go.Scatter(x=t_axis, y=i_wave, line=dict(color='dodgerblue'), opacity=0.3), row=1, col=2)

    fig.add_trace(go.Scatter(x=[theta_deg], y=[v_inst], mode='markers',
                             marker=dict(size=10, color='crimson')), row=1, col=2)

    fig.add_trace(go.Scatter(x=[theta_deg], y=[i_inst], mode='markers',
                             marker=dict(size=10, color='dodgerblue')), row=1, col=2)

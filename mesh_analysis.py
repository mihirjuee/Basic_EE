...
def draw_circuit():
    with schemdraw.Drawing() as d:
        ...
        d += elm.LoopCurrent([V_L, R1_e, R_S1, L1],
                             direction='cw', color=color1).label('$I_1$')
        ...
        d += elm.LoopCurrent([R_S1, R3_e, R_S2, L2],
                             direction='cw', color=color2).label('$I_2$')
        ...
        d += elm.LoopCurrent([R_S2, R5_e, V_R, L3],
                             direction='cw', color=color3).label('$I_3$')
...
# --- Footer ---
st.info("In shared branches, current = difference of mesh currents. Negative sign means opposite direction.")
